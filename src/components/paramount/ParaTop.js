...
const ParaTopBlock = styled.div`
    ...
    .contents_left{
        ...
        .info{
            display: flex; height: 34px;  margin-bottom: 40px;
            li{ 
...
//프리젠테이셔널 컴포넌트
function ParaTop({ paratop }) {
    const { name, poster, logo, age, type, time, para, seosen, drm, creator, cast, explain } = paratop;
